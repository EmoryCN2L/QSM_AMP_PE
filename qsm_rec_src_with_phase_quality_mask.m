...
LN_num = 10;    % the maximum number of computing threads
...
PhaseImagLoc = './data/phase_image.nii';
MagImgLoc = './data/mag_image.nii';
...
max_linearization_ite = 30;  % the maximum number of linearization steps to linearize the complex exponential measurement mdoel
...
% create the phase-based quality mask
N_std = real(N_std);

quality_mask = mask;
quality_mask(1./N_std<mean(1./N_std(N_std~=0))) = 0;

mask_large = mask;
mask = quality_mask;

quality_mask_without_holes = imfill(quality_mask, "holes");
mask = quality_mask_without_holes;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% perform Projection onto Dipole Field (PDF) %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
