...
% added the voxelsize option
% Data last modified: 02 March 2023
%
function unwrappedField = UnwrapPhase_3DBestPath_voxelsize(wrappedField,mask,matrixSize,voxelsize)
...
temp.hdr.dime.pixdim(2:4) = voxelsize;
